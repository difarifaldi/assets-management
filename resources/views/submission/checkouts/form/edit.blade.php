                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title font-weight-bold">Edit Pengajuan Peminjaman#{{ $submission->id }}</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control"
                                                ...
                                                value="{{ $submission->submissionFormsCheckoutDate->tanggal_pengajuan_peminjaman_aset }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_pengembalian_aset"
                                                ...
                                                value="{{ $submission->submissionFormsCheckoutDate->tanggal_pengembalian_aset }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
